...
ConvExecutor = namedtuple('ConvExecutor', ['executor', 'data', 'data_grad', 'style', 'content', 'out_name'])

def get_model(input_size, ctx, layer_name):#layer_name is string
    # declare symbol
    ...
    style = mx.sym.Group(eval(layer_name))
